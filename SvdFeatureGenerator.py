...
class SvdFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        print('headline svd features of training set saved in ' + str(outfilename_hsvd_train))
        ...
        if n_test > 0:
            ...
            print('headline svd features of test set saved in ' + str(outfilename_hsvd_test))
        ...
        print('body svd features of training set saved in ' + str(outfilename_bsvd_train))
        ...
        if n_test > 0:
            ...
            print('body svd features of test set saved in ' + str(outfilename_bsvd_test))
